...
#include DEVICE_FAMILY_PATH(rf_patches/rf_patch_cpe_genook.h)
#include DEVICE_FAMILY_PATH(rf_patches/rf_patch_rfe_genfsk.h)
#include DEVICE_FAMILY_PATH(rf_patches/rf_patch_rfe_genook.h)
#include DEVICE_FAMILY_PATH(rf_patches/rf_patch_mce_genook.h)
#include DEVICE_FAMILY_PATH(rf_patches/rf_patch_rfe_hsp_4mbps.h)
#include DEVICE_FAMILY_PATH(rf_patches/rf_patch_mce_hsp_4mbps.h)
