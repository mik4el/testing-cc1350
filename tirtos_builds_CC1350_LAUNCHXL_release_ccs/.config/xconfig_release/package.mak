...
/Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/ITarget.xs:
package.mak: /Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/ITarget.xs
/Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/C28_large.xs:
package.mak: /Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/C28_large.xs
/Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/C28_float.xs:
package.mak: /Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/C28_float.xs
/Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/package.xs:
package.mak: /Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/package.xs
/Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/arm/elf/IArm.xs:
package.mak: /Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/arm/elf/IArm.xs
/Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/arm/elf/package.xs:
package.mak: /Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/arm/elf/package.xs
...
ti.targets.arm.elf.M3.rootDir ?= /Applications/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.0.LTS
ti.targets.arm.elf.packageBase ?= /Users/mikaelandersson/ti/tirex-content/simplelink_cc13x0_sdk_1_00_00_13/kernel/tirtos/packages/ti/targets/arm/elf/
...
.dlls,em3 .dlls: release.pem3

-include package/cfg/release_pem3.mak
-include package/cfg/release_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/release_pem3.dep
endif
release.pem3: package/cfg/release_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
release.pem3 package/cfg/release_pem3.c: .libraries,em3
endif

package/cfg/release_pem3.c package/cfg/release_pem3.h package/cfg/release_pem3.xdl: override _PROG_NAME := release.xem3
package/cfg/release_pem3.c: package/cfg/release_pem3.cfg
package/cfg/release_pem3.xdc.inc: package/cfg/release_pem3.xdl
package/cfg/release_pem3.xdl package/cfg/release_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/release_pem3.cfg
	-$(RM) package/cfg/release_pem3.dep
	-$(RM) package/cfg/release_pem3.c
	-$(RM) package/cfg/release_pem3.xdc.inc

clean,em3::
	-$(RM) release.pem3
.executables,em3 .executables: release.xem3

release.xem3: |release.pem3

-include package/cfg/release.xem3.mak
release.xem3: package/cfg/release_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@) -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/release_pem3.oem3   package/cfg/release_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
release.xem3: export C_DIR=
release.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

release.test test,em3 test: release.xem3.test

release.xem3.test:: release.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 release.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.release.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,release.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
release_pem3.oem3,copy : package/cfg/release_pem3.oem3
release_pem3.sem3,copy : package/cfg/release_pem3.sem3
