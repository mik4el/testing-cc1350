/** \mainpage Driver Overview
  ...
  * - <b>Created</b>:          2017-01-17 12:51:40.344
...
/// Simple LMT70 ADC: Task configuration structure
typedef struct {
    uint16_t changeMask;        ///< 
    uint16_t minReportInterval; ///< 
} SCIF_SIMPLE_LMT70_ADC_CFG_T;
